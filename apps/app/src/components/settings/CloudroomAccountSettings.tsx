...
export function CloudroomAccountSettings() {
  ...
  return <SettingsSection title="Cloudroom account" description="Sign in to connect your existing cloud VM. Local execution stays available.">
    <div className="space-y-3 text-sm">
      ...
      <p className="text-xs text-muted-foreground">Automatic sync keeps selected projects, skills, portable agent settings, and your Codex login aligned both ways. Selecting a Cloud project also allows credentials in its files to sync. It continues when this app closes.</p>
