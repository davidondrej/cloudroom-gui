  ...
  return (
    <StoryCard labelWidth="150px">
      ...
      <StoryRow
        ...
        hint="Primary is the accent for buttons and selected controls. Foreground provides neutral emphasis for pills and badges. Both stay distinct from the quiet surface fills above."
      >
        <DualTheme>
          <div className="flex flex-wrap gap-2">
            <EmphasisChip
