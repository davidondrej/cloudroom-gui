...
describe("EnvironmentPickerUI Cloudroom checkout menu", () => {
  ...
  function mount({
    ...
    renderPicker(
      <EnvironmentPickerUI
        ...
        host={host}
        isLocal
        providers={[checkoutProvider, worktreeProvider, sandboxProvider]}
        selectedProviderHostId={host.id}
        cloud={{ selected, unavailableReason, onSelect: onSelectCloud }}
