...
export function createWorkflowService(
  ...
  function childPrompt(
    ...
    const header = `[cloudroom workflow ${run.name} · run ${run.id}]`;
      ...
      instructions:
        call.status !== "running"
          ...
          : options.outputSchema === null
            ? null
            : `You are a Cloudroom workflow worker. Submit your final value with bb_workflow_result. Required schema: ${JSON.stringify(options.outputSchema)}`,
    };
  }
