A workbench for people who build Cloudroom plugins. Enable it when you want a placeholder page in the sidebar that confirms plugin loading works in your build.
...
Use it as a smoke test when you change how Cloudroom loads bundled plugins. Use the Plugin Guide plugin to browse the full plugin API.
