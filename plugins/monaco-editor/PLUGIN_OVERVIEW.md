...
- Colors that follow your Cloudroom theme, including light and dark switches and custom palettes.

## How it works

The plugin claims common code, configuration, and text extensions. Binary files such as images and PDFs stay with Cloudroom's own preview. Files larger than 8 MB open in the read-only preview.
