Schedule work once or on a repeat, and let Cloudroom run it while you do something else. An automation can start an agent thread with a prompt, or run a stored script on the Cloudroom server.
