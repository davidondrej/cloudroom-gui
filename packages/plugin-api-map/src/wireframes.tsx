...
const FOOTER_ITEM_RENDERERS: Record<string, () => ReactNode> = {
  ...
  "cloudroom-account": () => <span className="text-xs">Sign in</span>,
};
...
function RightPanelTabLaneBadges({
  ...
  return (
    <>
      ...
      <MeasuredBadge
        id="code-renderers"
        label="Plugin code and diff renderers on Cloudroom's Diff tab"
            ...
            >
              ...
              >
                ...
                <MeasuredBadge
                  ...
                  label="Plugin actions in Cloudroom's quick command palette"
      ...
      <div className="mx-auto min-h-[470px] w-full max-w-[520px] space-y-4 px-4 pb-5 pt-4">
        ...
        <div className="space-y-2">
          ...
          <Mark
            ...
            label="The form Cloudroom generates from the fields you declare"
  ...
  return (
    <WindowFrame>
      ...
      <div className="flex min-h-[470px] flex-col">
        <Mark
          id="plugin-status"
          label="The needs-configuration banner Cloudroom shows for a plugin that reports it"
