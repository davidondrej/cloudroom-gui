...
## Cloudroom connection

This fork uses `~/.gui-cloudroom` by default. Its server-only `cloudroom.json`
contains `url`, `token`, and `projectId`, with permissions `0600`. Configure it
